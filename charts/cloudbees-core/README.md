...
| Agents.image.repository | string | `"@@AGENT_NAME@@"` | Container image repository for the agent |
...
| Common.image.registry | string | `"063356183961.dkr.ecr.us-east-1.amazonaws.com/ubi/unified-distribution"` | container registry for the images |
| Common.image.tag | string | `"2.387.2.4"` | container image tag |
...
| Hibernation.image.tag | string | `"267.488becfaaab6"` | container image tag |
...
| Master.image.repository | string | `"@@MM_NAME@@"` | Container image repository for the controller |
